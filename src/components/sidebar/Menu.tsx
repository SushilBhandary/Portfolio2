...
const Menu: FC<MenuProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/zuzhil_/"
        effect="slideUp"
      >
        <Instagram color="#b5179e" /> Instagram
      </List>
      <List target="_blank" link="https://github.com/sushilbhandary" effect="slideUp">
        <Github color="#2a9d8f" /> Github
      </List>
      <List
        target="_blank"
        link="https://www.linkedin.com/in/sushil-bhandary/"
        effect="slideUp"
      >
